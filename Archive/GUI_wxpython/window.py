...
class Frame(wx.Frame):
    def __init__(self):
        ...
        #self.animation.Play()
        startlisten_pic = wx.Image(r'GUI_wxpython/image_processing20191206-10006-1o4c5ii.jpg').ConvertToBitmap()
        ...
        self.animation.Hide()
        self.animation.LoadFile(r'GUI_wxpython/Voice assistant motion effect.gif')
