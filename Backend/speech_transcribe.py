...
class SpeechTranscriber:
    ...
    def text_to_speech(self, text, src_lang="eng", tgt_lang="cmn"):
    ...
    def speech_to_text(self, audio_path, tgt_lang="cmn"):
    ...
    def text_to_text(self, text, src_lang="eng", tgt_lang="cmn"):
        text_inputs = self.processor(text=text, src_lang=src_lang, return_tensors="pt")
