...
class Frame(wx.Frame):
    def __init__(self):
        ...
        #self.animation.Play()
        startlisten_pic = wx.Image(r'/Users/cliozhu/Desktop/image_processing20191206-10006-1o4c5ii.jpg').ConvertToBitmap()
        ...
        self.animation.Hide()
        self.animation.LoadFile(r'/Users/cliozhu/Desktop/Voice assistant motion effect.gif')
